...
CREATE TABLE IF NOT EXISTS public.parametres (
  ...
  nom_restaurant TEXT DEFAULT 'LeLieu — Rumba & Old School Lounge',
  logo_url      TEXT,
  adresse       TEXT DEFAULT '2, Avenue Tombalbaye, Gombe, Kinshasa — Immeuble Otantika (Réf. Rond Point Kin Mazière)',
  telephone     TEXT DEFAULT '+243 820 290 491',
  whatsapp      TEXT DEFAULT '243820290491',
  horaires      TEXT DEFAULT 'Lundi - Dimanche · 12h00 - tard dans la nuit',
...
VALUES (1, 'LeLieu — Rumba & Old School Lounge', NULL, '2, Avenue Tombalbaye, Gombe, Kinshasa — Immeuble Otantika (Réf. Rond Point Kin Mazière)', '+243 820 290 491', '243820290491', 'Lundi - Dimanche · 12h00 - tard dans la nuit')
